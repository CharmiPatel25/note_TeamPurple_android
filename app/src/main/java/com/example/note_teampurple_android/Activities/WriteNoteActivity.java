...
import com.example.note_teampurple_android.utils.ImageCompress;
import com.example.note_teampurple_android.utils.ImagePicker;
...
public class WriteNoteActivity extends BaseActivity implements View.OnClickListener, RecognitionListener {
    ...
    private static final String LOG_TAG = "teamPurple";
    BubbleNavigationLinearView bubbleNavigationLinearView;
    ImageCompress imageCompressionLikeWhatsapp;
    Dialog dialog;
...
//    BubbleToggleView l_micnavigation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WriteNoteActivity.this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN); //enable full screen
        ...
        imageCompressionLikeWhatsapp = new ImageCompress(WriteNoteActivity.this);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    if (navigation > 1) {
                        ...
                        Intent intent = new Intent(WriteNoteActivity.this, Userlocation.class);
...
//        });
    ...
    private void showGPSDisabledAlertToUser() {
        ...
        dialog = new Dialog(WriteNoteActivity.this);
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WriteNoteActivity.this.startActivity(new Intent(android.provider.Settings.ACTION_LOCATION_SOURCE_SETTINGS));
            }
        });
    ...
    public void showchooser() {
        ...
        dialog = new Dialog(WriteNoteActivity.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        WriteNoteActivity.this.getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    void galleryImageIntent() {
        Intent intent = null;
        try {
            intent = ImagePicker.getPickImageIntent(WriteNoteActivity.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (ActivityCompat.checkSelfPermission(WriteNoteActivity.this, permissionsRequired[0]) == PackageManager.PERMISSION_GRANTED) {
                //Got Permission
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    public String getRealPathFromURI(Uri contentUri) {
        ...
        Cursor cursor = WriteNoteActivity.this.getContentResolver().query(contentUri, proj, null, null, null);
    ...
    public File getPhotoFileUri() {
        ...
        File mediaStorageDir = new File(WriteNoteActivity.this.getExternalFilesDir(Environment.DIRECTORY_PICTURES), "firechat");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_CALLBACK_CONSTANT) {
            ...
            } else if (ActivityCompat.shouldShowRequestPermissionRationale(WriteNoteActivity.this, permissionsRequired[0])
                    || ActivityCompat.shouldShowRequestPermissionRationale(WriteNoteActivity.this, permissionsRequired[1])
                    || ActivityCompat.shouldShowRequestPermissionRationale(WriteNoteActivity.this, permissionsRequired[2])) {
    ...
    public void askfor_permissions() {
        if (ActivityCompat.checkSelfPermission(WriteNoteActivity.this, permissionsRequired[0]) != PackageManager.PERMISSION_GRANTED
                || ActivityCompat.checkSelfPermission(WriteNoteActivity.this, permissionsRequired[1]) != PackageManager.PERMISSION_GRANTED
                || ActivityCompat.checkSelfPermission(WriteNoteActivity.this, permissionsRequired[2]) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(WriteNoteActivity.this, permissionsRequired[0])
                    || ActivityCompat.shouldShowRequestPermissionRationale(WriteNoteActivity.this, permissionsRequired[1])
                    || ActivityCompat.shouldShowRequestPermissionRationale(WriteNoteActivity.this, permissionsRequired[2])) {

                ActivityCompat.requestPermissions(WriteNoteActivity.this, permissionsRequired, PERMISSION_CALLBACK_CONSTANT);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_keyshow:
                if(hidekeyboard)
                {
                    hideKeyboard(WriteNoteActivity.this);
            ...
            case R.id.start_audio:
                ...
                if (checkPermission()) {
                    ...
                    try {
                        ...
                        Toast.makeText(WriteNoteActivity.this, "Recording started" + e, Toast.LENGTH_LONG).show();
                        e.printStackTrace();
                    }

                    Toast.makeText(WriteNoteActivity.this, "Recording started", Toast.LENGTH_LONG).show();
            ...
            case R.id.stop_audio:
                ...
                Toast.makeText(WriteNoteActivity.this, "Recording Completed", Toast.LENGTH_LONG).show();
            ...
            case R.id.play_audio:
                ...
                mediaPlayer.start();
                Toast.makeText(WriteNoteActivity.this, "Recording Playing", Toast.LENGTH_LONG).show();
    ...
    public boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(WriteNoteActivity.this, WRITE_EXTERNAL_STORAGE);
        int result1 = ContextCompat.checkSelfPermission(WriteNoteActivity.this, RECORD_AUDIO);
    ...
    public void onBeginningOfSpeech() {
        ...
        Toast.makeText(WriteNoteActivity.this, "onBeginningOfSpeech", Toast.LENGTH_LONG).show();
    ...
    public void onBufferReceived(byte[] buffer) {
        ...
        Toast.makeText(WriteNoteActivity.this, "onBufferReceived", Toast.LENGTH_LONG).show();
    }

    @Override
    public void onEndOfSpeech() {
        Log.i(LOG_TAG, "onEndOfSpeech");
        Toast.makeText(WriteNoteActivity.this, "onEndOfSpeech", Toast.LENGTH_LONG).show();
    ...
    public void onError(int errorCode) {
        ...
        Toast.makeText(WriteNoteActivity.this, "" + errorMessage, Toast.LENGTH_LONG).show();
        //toggleButton.setChecked(false);
        mic_layout.setVisibility(View.GONE);
    }
...
//        progressBar.setProgress((int) rmsdB);
    ...
    public void savenote() {
        if (edt_title.getText().toString().isEmpty() || edt_subject.getText().toString().isEmpty() || edt_title.getText().toString().equals("") || edt_subject.getText().toString().equals("")) {
            displayAlert(WriteNoteActivity.this, "Please input Text and Title");
        } else {
            ...
            AppExecutors.getInstance().diskIO().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    intent = new Intent(WriteNoteActivity.this, MainActivity.class);
                    startActivity(intent);
                    // retrieveTasks();
                }
            });
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        displayAlert(WriteNoteActivity.this, "" + text);
                    }
                });
            }
        });
