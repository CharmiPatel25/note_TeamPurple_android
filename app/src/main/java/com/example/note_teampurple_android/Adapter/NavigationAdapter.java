...
public class NavigationAdapter extends RecyclerView.Adapter<com.example.note_teampurple_android.Adapter.NavigationAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final com.example.note_teampurple_android.Adapter.NavigationAdapter.MyViewHolder holder, final int position)
    {
